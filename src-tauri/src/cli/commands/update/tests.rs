...
fn release_page_url_for_github_com() {
    let url = release_page_url("https://github.com/zekza/cc-switch-cli", "latest")
        .expect("release page url should be built");
    assert_eq!(
        url.as_str(),
        "https://github.com/zekza/cc-switch-cli/releases/latest"
    );
}
...
fn release_api_url_for_github_com() {
    let url = release_api_url("https://github.com/zekza/cc-switch-cli", "latest")
        .expect("api url should be built");
    assert_eq!(
        url.as_str(),
        "https://api.github.com/repos/zekza/cc-switch-cli/releases/latest"
    );
}

#[test]
fn extract_release_tag_from_url_reads_release_tag_page() {
    let url = Url::parse("https://github.com/zekza/cc-switch-cli/releases/tag/v4.6.2")
